...
3. Download the Clean Main Menu mod from [ModWorkshop](https://modworkshop.net/mod/) or [GitHub Releases](https://github.com/eidenvelsberg/pd2-clothing-physics-fix/releases)
4. Extract this mod folder into your `PAYDAY 2/mods/` directory
### If SuperBLT is already installed
1. Download the Clean Main Menu mod from [ModWorkshop](https://modworkshop.net/mod/) or [GitHub Releases](https://github.com/eidenvelsberg/pd2-clothing-physics-fix/releases)
